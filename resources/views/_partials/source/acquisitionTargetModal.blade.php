			<div class="modal fade" id="acquisitionTargetModal" tabindex="-1" role="dialog" aria-labelledby="acquisitionTargetModalLabel" aria-hidden="true">
					...
					<div class="modal-content">
						<div class="row mt-3 ml-0 mr-0 mb-3">
							<div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4">
								<h5 class="font-interface-bold text-center text-sm-center text-md-center text-lg-left text-xl-left text-white text-uppercase mb-3" id="acquisitionTargetModalLabel">Submit an Acquisition Target<br><small class="text-safetynet-orange">{{ implode(' / ', $breadcrumbs) }}</small></h5>
							</div>
							<div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
								<form name="acquisitionTarget" id="acquisitionTarget" class="acquisitionTarget" role="form" method="POST" action="/{{ $department->slug }}/form-submission" enctype="multipart/form-data">
									{{ csrf_field() }}
									<input type="hidden" name="form" value="Acquisition Target">
									...
									<div class="form-group row mt-3 ml-0 mr-0 mb-3">
										...
										<div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 text-left">
											<button type="submit" name="submit_acquisition_target" id="submit_acquisition_target" class="btn btn-safetynet-orange text-uppercase" tabindex="4" title="Submit">Submit</button>
										</div>
										<div class="col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 text-right">
											<button type="button" name="cancel_acquisition_target" id="cancel_acquisition_target" class="btn btn-secondary text-uppercase" tabindex="5" title="Cancel" data-dismiss="modal">Cancel</button>
										</div>
									</div>
								</form>
							</div>
