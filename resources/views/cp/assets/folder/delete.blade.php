...
@section('content')
		...
		<div class="{{ $mainSmCols }} {{ $mainMdCols }} {{ $mainLgCols }} {{ $mainXlCols }} main">
			...
			<div class="content padding bg-white">
				<p class="text-center text-sm-center text-md-left text-lg-left text-xl-left">Please confirm that you wish to delete the <strong>{{ $folder }}</strong> folder and any sub-folders and/or files.</p>
				...
				<form name="removeFolderAsset" id="removeFolderAsset" class="removeFolderAsset" role="form" method="POST" action="/cp/assets/folder">
					...
					<div class="form-buttons">
						...
						@endif
						<button type="submit" name="submit_remove_folder_assets" id="submit_remove_folder_assets" class="pull-right btn btn-danger" tabindex="1" title="Delete">Delete</button>
					</div>
				</form>
			</div>
