...
@section('formButtons')
	<div class="form-buttons">
		...
		@endif
		<button type="submit" name="submit_edit_location" id="submit_edit_location" class="pull-right btn btn-primary" title="Save Changes"><i class="icon fa fa-check-circle" aria-hidden="true"></i>Save Changes</button>
	</div>
@endsection
			...
			<div class="content padding bg-white">
				<form name="editLocation" id="editLocation" class="editLocation" role="form" method="POST" action="/cp/locations/{{ $location->id }}">
					...
					<div class="form-group">
						...
						<input type="text" name="title" id="title" class="form-control" value="{{ old('title', optional($location)->title) }}" placeholder="e.g Test Title" tabindex="1" autocomplete="off" aria-describedby="helpBlockTitle" required autofocus>
						@if ($errors->has('title'))
					...
					<div class="form-group">
						...
						<input type="text" name="unit" id="unit" class="form-control" value="{{ old('unit', optional($location)->unit) }}" placeholder="e.g Test Unit" tabindex="2" autocomplete="off" aria-describedby="helpBlockUnit">
						@if ($errors->has('unit'))
					...
					<div class="form-group">
						...
						<input type="text" name="building" id="building" class="form-control" value="{{ old('building', optional($location)->building) }}" placeholder="e.g Test Building" tabindex="3" autocomplete="off" aria-describedby="helpBlockBuilding">
					...
					<div class="form-group">
						...
						<input type="text" name="street_address_1" id="street_address_1" class="form-control" value="{{ old('street_address_1', optional($location)->street_address_1) }}" placeholder="e.g Street Address 1" tabindex="4" autocomplete="off" aria-describedby="helpBlockStreetAddress1" required>
					...
					<div class="form-group">
						...
						<input type="text" name="street_address_2" id="street_address_2" class="form-control" value="{{ old('street_address_2', optional($location)->street_address_2) }}" placeholder="e.g Street Address 2" tabindex="5" autocomplete="off" aria-describedby="helpBlockStreetAddress2">
					...
					<div class="form-group">
						...
						<input type="text" name="street_address_3" id="street_address_3" class="form-control" value="{{ old('street_address_3', optional($location)->street_address_3) }}" placeholder="e.g Street Address 3" tabindex="6" autocomplete="off" aria-describedby="helpBlockStreetAddress3">
					...
					<div class="form-group">
						...
						<input type="text" name="street_address_4" id="street_address_4" class="form-control" value="{{ old('street_address_4', optional($location)->street_address_4) }}" placeholder="e.g Street Address 4" tabindex="7" autocomplete="off" aria-describedby="helpBlockStreetAddress4">
					...
					<div class="form-group">
						...
						<input type="text" name="town_city" id="town_city" class="form-control" value="{{ old('town_city', optional($location)->town_city) }}" placeholder="e.g Town / City" tabindex="8" autocomplete="off" aria-describedby="helpBlockTownCity" required>
					...
					<div class="form-group">
						...
						<input type="text" name="postal_code" id="postal_code" class="form-control" value="{{ old('postal_code', optional($location)->postal_code) }}" placeholder="e.g Postal Code" tabindex="9" autocomplete="off" aria-describedby="helpBlockPostalCode">
					...
					<div class="form-group">
						...
						<input type="tel" name="telephone" id="telephone" class="form-control" value="{{ old('telephone', optional($location)->telephone) }}" placeholder="e.g +44 1224 123 4567" tabindex="12" autocomplete="off" aria-describedby="helpBlockTelephone">
					...
					<div class="form-group">
						...
						<input type="tel" name="fax" id="fax" class="form-control" value="{{ old('fax', optional($location)->fax) }}" placeholder="e.g +44 1224 123 4567" tabindex="13" autocomplete="off" aria-describedby="helpBlockFax">
						@if ($errors->has('fax'))
					...
					<div class="form-group">
						...
						<input type="email" name="email" id="email" class="form-control" value="{{ old('email', optional($location)->email) }}" placeholder="e.g joe@bloggs.com" tabindex="14" autocomplete="off" aria-describedby="helpBlockEmailAddress">
						@if ($errors->has('email'))
						...
						<div class="custom-controls-stacked">
							@foreach ($statuses as $status)
								<div class="custom-control custom-radio d-flex h-100 justify-content-start status_id-{{ $status->id }}">
									<input type="radio" name="status_id" id="status_id-{{ str_slug($status->title) }}" class="custom-control-input" value="{{ $status->id }}" tabindex="15" aria-describedby="helpBlockStatusId" {{ (old('status_id') == $status->id || $location->status_id == $status->id) ? 'checked' : ($loop->first) ? 'checked' : '' }}>
