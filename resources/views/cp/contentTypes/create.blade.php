...
@section('title', 'Create Content Type - Content Types - '.config('app.name'))
@section('description', 'Create Content Type - Content Types - '.config('app.name'))
@section('keywords', 'Create, Content Type, Content Types, '.config('app.name'))
...
@section('formButtons')
	<div class="form-buttons">
		...
		@endif
		<button type="submit" name="submit_create_content_type" id="submit_create_content_type" class="pull-right btn btn-primary" title="Save Changes"><i class="icon fa fa-check-circle" aria-hidden="true"></i>Save Changes</button>
	</div>
@endsection
...
@section('content')
		...
		<div class="{{ $mainSmCols }} {{ $mainMdCols }} {{ $mainLgCols }} {{ $mainXlCols }} main">
			...
			<div class="content padding bg-white">
				<form name="createContentType" id="createContentType" class="createContentType" role="form" method="POST" action="/cp/content-types">
					{{ csrf_field() }}
					@yield('formButtons')
