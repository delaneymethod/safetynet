			...
			<div class="content padding bg-white">
				<form name="editGlobal" id="editGlobal" class="editGlobal" role="form" method="POST" action="/cp/globals/{{ $global->id }}">
					...
					<div class="form-group">
						...
						<textarea name="data" id="data" class="form-control" autocomplete="off" placeholder="e.g https://twitter.com/delaneymethod" rows="5" cols="50" tabindex="3" aria-describedby="helpBlockData">{{ old('data', optional($global)->data) }}</textarea>
						@if ($errors->has('data'))
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" name="image" id="image" class="form-control" autocomplete="off" placeholder="e.g Test Image" value="{{ old('image', optional($global)->image) }}" tabindex="4" autocomplete="off" aria-describedby="helpBlockImage">
